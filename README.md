...
This skeleton is based on a similar skeleton created by [Pablo González](https://github.com/Arquisoft/radarin_0) which is a bit more complex because the web client is implemented as a React application and the server contains monitoring and load testing.
